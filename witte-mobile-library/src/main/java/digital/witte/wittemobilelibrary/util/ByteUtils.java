...
public class ByteUtils {
    ...
    /**
     * Convert a byte in its binary string representation.
     *
     * @param byteValue
     * @return The binary string representation of the byteValue
     */
    public static String toBitString(byte byteValue) {
